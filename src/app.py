...
"Swimming Club": {
    "description": "Swim training, stroke improvement, and lap sessions",
    "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
    "max_participants": 18,
    "participants": []
},
"Art Workshop": {
    "description": "Creative painting, drawing, and mixed-media projects",
...
"Math Olympiad Prep": {
    "description": "Advanced problem solving for math competition practice",
